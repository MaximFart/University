...
//        model.addAttribute("departments", departmentDaoService.findAll().stream().map(Optional::get).collect(Collectors.toList()));
//        return "department/departments";
//    }
//    @GetMapping("/{id}")
//    public String getById(@PathVariable("id") int id, Model model) throws Exception {
//        model.addAttribute("department", departmentDaoService.getById(id).get());
...
//        departmentDaoService.update(department, id);
//        return "redirect:/departments";
//    }
//
//    @DeleteMapping("/{id}")
